...
from pyconbalkan.timetable.views import timetable_view, timetable_sessionize_view
...
urlpatterns = [
    ...
    path('timetable/', timetable_sessionize_view, name='timetable'),
    path('timetable_new/', timetable_view, name='timetable_new'),
